...
export function getExperimentalMultiWindowSearchEntry(): SettingsSearchEntry {
  return {
    title: translate('auto.components.settings.experimental.search.818dac284f', 'Multi-window'),
