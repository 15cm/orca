...
- `--setup run|skip|inherit` controls repo setup hooks. Default is `inherit`, which follows the repository override, then global Default Workspace Setup. Omitted setup behaves the same as `inherit`.
